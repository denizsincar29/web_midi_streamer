...
export const translations = {
    en: {
        ...
        'connection.connectBtn': 'Join Room',
        'connection.createBtn': 'Create & Join',
        ...
        // WebRTC status
        'webrtc.connecting': '🔗 Connecting to room server…',
        ...
        'webrtc.signalFailed': 'Unable to reach the room server — check your connection',
        ...
        'version.stalePeer': '⚠️ {nick} is running an old version ({version}) — ask them to reload the page',
    ...
    ru: {
        ...
        'connection.connectBtn': 'Войти в комнату',
        'connection.createBtn': 'Создать и войти',
        ...
        // WebRTC status
        'webrtc.connecting': '🔗 Подключение к серверу комнат…',
        ...
        'webrtc.signalFailed': 'Нет связи с сервером — проверьте соединение',
        ...
        'version.stalePeer': '⚠️ {nick} использует старую версию ({version}) — попросите их перезагрузить страницу',
